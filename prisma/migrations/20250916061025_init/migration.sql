-- CreateEnum
CREATE TYPE "public"."PostType" AS ENUM ('NEWS', 'SHARE', 'NEED');
...
CREATE TABLE "public"."Post" (
    "id" TEXT NOT NULL,
    "type" "public"."PostType" NOT NULL DEFAULT 'SHARE',
    "title" TEXT NOT NULL,
    "description" TEXT,
    "content" TEXT,
    "imageUrl" TEXT,
...
-- CreateIndex
CREATE INDEX "Post_type_createdAt_idx" ON "public"."Post"("type", "createdAt");
